...
@objc
public class LivePhoto: NSObject {
    // MARK: PUBLIC
    ...
    @objc
    public class func extractResources(from livePhoto: PHLivePhoto, completion: ((_ pairedImage: URL?, _ pairedVideo: URL?) -> Void)?) {
        queue.async {
    ...
    @objc
    public class func generate(from imageURL: URL?, videoURL: URL, progress: @escaping (CGFloat) -> Void, completion: @escaping (PHLivePhoto?, URL?, URL?) -> Void) {
        queue.async {
    ...
    private func generate(from imageURL: URL?, videoURL: URL, progress: @escaping (CGFloat) -> Void, completion: @escaping (PHLivePhoto?, URL?, URL?) -> Void) {
  ...
  private func extractResources(from livePhoto: PHLivePhoto, to directoryURL: URL, completion: ((_ pairedImage: URL?, _ pairedVideo: URL?) -> Void)?) {
    ...
    private func extractResources(from livePhoto: PHLivePhoto, completion: ((_ pairedImage: URL?, _ pairedVideo: URL?) -> Void)?) {
        if let cacheDirectory = cacheDirectory {
